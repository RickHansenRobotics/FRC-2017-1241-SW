...
public class LeftGearCommandBlue extends CommandGroup {
    ...
    public LeftGearCommandBlue() {
        ...
        // arm.
    	addSequential(new DriveCommand(95, 0.8, 0, 2));
    	addSequential(new TurnCommand(57, 0.8, 1, 1));
    	addSequential(new DriveCommand(31, 0.6, 54, 5));
    	//addSequential(new ResetSensorsCommand());
    	//addSequential(new DrivePath(new Point(0,120),new Point(60,240), new Point(60,100), new Point(60,0), 5, 0.8, true));
    }
}
